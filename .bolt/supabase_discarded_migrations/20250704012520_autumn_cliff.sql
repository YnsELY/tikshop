/*
  # Create product variants table and sample data
  ...
  2. Changes
    ...
    - Add sample products with variants for testing
...
DROP POLICY IF EXISTS "Sellers can manage own product variants" ON product_variants;
DROP POLICY IF EXISTS "Admin can manage own product variants" ON product_variants;
DROP POLICY IF EXISTS "Créer des variantes" ON product_variants;
...
-- Politique pour que les admins puissent gérer toutes les variantes
CREATE POLICY "Admin can manage own product variants"
  ON product_variants
  FOR ALL
  TO authenticated
  USING (
...
-- Politique pour créer des variantes (admins seulement)
CREATE POLICY "Créer des variantes"
  ON product_variants
  FOR INSERT
  TO public
  WITH CHECK (
...
-- Créer des produits de test et leurs variantes (sans créer de profils)
DO $$
DECLARE
  tshirt_id uuid;
  jean_id uuid;
  ...
  chemise_id uuid;
BEGIN
  -- Insérer des produits de test de type vêtements (sans seller_id pour éviter les contraintes)
  INSERT INTO products (reference, name, description, price, image_url, category, seller_id) VALUES
  ('TSHIRT-BIO-2025', 'T-Shirt Bio Premium', 'T-shirt en coton biologique, coupe moderne et confortable. Parfait pour un style décontracté.', 29.99, 'https://images.pexels.com/photos/1192609/pexels-photo-1192609.jpeg?auto=compress&cs=tinysrgb&w=400', 'Vêtements', NULL),
  ('JEAN-SLIM-CLASSIC', 'Jean Slim Classique', 'Jean slim fit en denim de qualité supérieure. Coupe moderne et élégante.', 79.99, 'https://images.pexels.com/photos/1598507/pexels-photo-1598507.jpeg?auto=compress&cs=tinysrgb&w=400', 'Vêtements', NULL),
  ('PULL-LAINE-HIVER', 'Pull en Laine d''Hiver', 'Pull chaud en laine mérinos, idéal pour les journées froides. Doux et confortable.', 89.99, 'https://images.pexels.com/photos/1183266/pexels-photo-1183266.jpeg?auto=compress&cs=tinysrgb&w=400', 'Vêtements', NULL),
  ('ROBE-ETE-FLEURIE', 'Robe d''Été Fleurie', 'Robe légère et colorée, parfaite pour l''été. Motifs floraux tendance.', 59.99, 'https://images.pexels.com/photos/1536619/pexels-photo-1536619.jpeg?auto=compress&cs=tinysrgb&w=400', 'Vêtements', NULL),
  ('CHEMISE-BUSINESS', 'Chemise Business', 'Chemise élégante pour le bureau. Coupe ajustée et tissu de qualité.', 49.99, 'https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&w=400', 'Vêtements', NULL)

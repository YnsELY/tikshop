/*
  # Ajout des variantes de produits avec couleurs et tailles
  ...
  2. Modifications
    ...
    - Ajout de produits de test de type vêtements
    - Création de variantes avec différentes couleurs et tailles

/*
  ...
  2. Modifications
    ...
    - Le stock est maintenant géré au niveau des variantes

  3. Sécurité
    - Enable RLS sur `product_variants`
    - Politique de lecture publique
    - Politique de gestion pour les vendeurs authentifiés

  4. Données de test
    - 5 produits de vêtements avec différentes variantes
    - Chaque produit a plusieurs couleurs et tailles
    - Stock différent pour chaque variante
*/
...
SELECT p.id, v.color, v.size, v.stock, v.sku 
